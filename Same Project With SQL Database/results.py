...
class ResultClass:
  ...
  # functions started================
    ...
    def search(self):
        ...
        try:
            cursor.execute(
                "SELECT name, course FROM student WHERE roll = %s", (self.var_roll.get(),))
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "":
                ...
                cursor.execute("SELECT * FROM result WHERE roll = %s AND course = %s",
                ...
                if row != None:
                    ...
                    insert_query = "INSERT INTO result (roll, name, course, marks_ob, full_marks, per) VALUES (%s, %s, %s, %s, %s, %s)"
                    data = (
                        self.var_roll.get(),
                        self.var_name.get(),
                        self.var_course.get(),
