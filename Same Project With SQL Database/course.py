        ...
        try:
            if self.var_course.get() == "":
                ...
                if row != None:
                    ...
                    cursor.execute("INSERT INTO course (name, duration, charges, description) VALUES (%s, %s, %s, %s)", (
                        self.var_course.get(),
        ...
        try:
            if self.var_course.get() == "":
                ...
                if row == None:
                    ...
                    cursor.execute("UPDATE course SET duration = %s, charges = %s, description = %s WHERE name = %s", (
                        self.var_duration.get(),
                        self.var_charges.get(),
                        self.txt_course_description.get("1.0", END),
                        self.var_course.get()
